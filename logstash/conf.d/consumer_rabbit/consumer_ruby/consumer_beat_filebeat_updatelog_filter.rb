...
def register (params)
    ...
    print ""
    print "***** ****** ***** "
    print "consumer_beat_filebeat_updatelog_filter.rb : register method is called. "
    print "***** ***** ***** "
end
...
def filter(event)
  ...
  msg = JSON.parse(msg)
   ...
   msg.each{|key, value|
             ...
             if key == "_timestamp" or key == "message_timestamp" or key == "service_stop_time" or key == "service_start_time"
